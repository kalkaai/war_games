Audit the GAMIDES web app for Answer Engine Optimization (AEO) — readiness to be cited by AI search engines (Perplexity, ChatGPT Search, Google AI Overviews, Grok, etc.).
