...
export const metadata: Metadata = {
  title: "Changelog — WarGuard | Last Z",
  description: "WarGuard update history for Last Z players: new pages, data updates, balance fixes, and feature releases. Version history from 0.1.0 through 0.4.0.",
  openGraph: {
    title: "Changelog — WarGuard | Last Z",
    description: "WarGuard update history for Last Z players: new pages, data updates, and feature releases.",

  },
  alternates: {
    canonical: "https://warguard.app/changelog",
  },
};
...
export default function ChangelogPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <h1 className="text-3xl font-extrabold text-white sm:text-4xl">Last Z Changelog</h1>
      <p className="mt-2 text-purple-300/70">WarGuard update history.</p>

      <h2 className="mt-8 text-xl font-bold text-white">What Has Changed in WarGuard?</h2>
        ...
        {ENTRIES.map((entry) => (
          ...
          >
            ...
            <ul className="mt-3 space-y-1">
              {entry.changes.map((c) => (
                <li key={c} className="flex items-start gap-2 text-sm text-purple-200/80">
