...
export const metadata: Metadata = {
  title: "Research Trees — WarGuard | Last Z",
  ...
  alternates: {
    canonical: "https://warguard.app/research",
  },
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mt-2 text-purple-300/70">
        9 trees · {fmtBadges(totalBadges)} total badges to max everything
      </p>
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {trees.map((tree) => (
          <Link
            ...
            className="group rounded-xl border border-purple-800/50 bg-purple-900/30 p-5 transition-all hover:border-purple-500 hover:bg-purple-900/50"
          >
            ...
            <h2 className="mt-3 text-base font-bold text-white group-hover:text-purple-200">
              {tree.name}
            </h2>
      ...
      <p className="mt-6 text-xs text-purple-400/50">
        Badge totals verified against lastz.stresswar.com. Node data sourced from lastzguides.com and wild-hoggs.com. Last updated May 2026.
      </p>
    </div>
  );
}
